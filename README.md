# Useful-Articles
A list of development-related articles that I find helpful.

## iOS

  #### Practical applications
  - [SwiftUI](https://goshdarnswiftui.com)
  ...
  - [GeoJSON File Generator](http://geojson.io/?source=post_page---------------------------#map=1/65/-60)
  ...
  #### Books
  - [Design Better (Animations)](https://www.designbetter.co/animation-handbook/purpose)
  
 #### Weird bugs solutions 
  - [Refresh Control + Large titles](https://stackoverflow.com/questions/50708081/prefer-large-titles-and-refreshcontrol-not-working-well)
